...
## 📚 Definition
**Static intervention**: An intervention is static if the function $\dd_t$ always returns the same value regardless of the input.
:::
...
::: {.callout-important appearance="simple"}
## 📚 Definition
**Dynamic treatment regime**: Interventions where the output of the function $\dd$ depends *only on the covariates* $H_t$ are referred to as being dynamic.
:::
...
::: {.callout-important appearance="simple"}
## 📚 Definition
**Modified treatment policy**: An intervention characterized by a hypothetical world where the *natural* value of treatment is modified is called a *modified treatment policy*.
:::
...
::: {.callout-important appearance="simple"}
## 📚 Definition
**Incremental propensity score intervention**: An intervention where the conditional probability of treatment is shifted. 
:::
