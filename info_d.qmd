...
* At time point $t=1$, the post-intervention treatment is assigned as $A_2^\dd = \dd(A_2^{A_1^\dd}, L_2^{A_1^\dd}, A_1^\dd, L1)$. This generates a counterfactual treatment at time $t=3.
