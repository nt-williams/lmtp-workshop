...
$$
\dd_t(a_t, \epsilon_t) = \begin{cases}
...
```{=tex}
\begin{align} \m_3(A_3^\dd, H_3) &= Y   \\  \m_2(A_2^d, H_2) &= \E\left[\m_3(A_3^\dd, H_3)\mid(A_2^\dd, H_2)\right] \\\m_1(A_1^\dd, L_1) &= \E\left[\m_2(A_2^\dd, H_2)\mid(A_1^\dd, L_1)\right] \\\theta &= \E\left[\m_1(A_1^\dd, L_1)\right]
