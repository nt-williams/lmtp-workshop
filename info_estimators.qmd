...
1.  defined a causal parameter $\theta$ that is represents the outcome $Y$ under a general hypothetical intervention implied by the function $\dd(a_t, h_t, \epsilon)$, and
