...
First released on CRAN in the Summer of 2021, the `lmtp` package is the software companion to the paper by @diaz2023nonparametric that generalized MTPs to the longitudinal setting.
