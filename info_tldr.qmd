...
| $Y = L_t$                                       | An outcome variable                                                                    |
| $C$                                             | A indicator variable that a unit is *observed* at the next time point                  |
| $O_1, ..., O_n$                                 | A sample of i.i.d observations with $O = (L_1, A_1, L_2, A_2, ..., L_\tau, A_\tau, Y)$ |
